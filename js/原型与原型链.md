...
### 原型链图
![](https://img-blog.csdnimg.cn/20201028084614540.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80Mzk3MzQxNQ==,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](C:\Users\lhq\Desktop\20201028084858987.png)
### 原型
...
- ![在这里插入图片描述](C:\Users\lhq\Desktop\20201028085922414.png)
- instanceof是判断实例对象的`__proto__`和生成该实例的构造函数的`prototype`是不是引用的同一个地址，是返回true，否返回false。
- ![在这里插入图片描述](C:\Users\lhq\Desktop\20201028091403284.png)
- 判断实例是由哪个构造函数生成的，需要用到constructor。
- ![在这里插入图片描述](C:\Users\lhq\Desktop\20201028091414721.png)
...
- 参考如下图，
- ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210201132006113.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80Mzk3MzQxNQ==,size_16,color_FFFFFF,t_70)- ![在这里插入图片描述](https://img-blog.csdnimg.cn/20210201132121599.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80Mzk3MzQxNQ==,size_16,color_FFFFFF,t_70)
- 总结：
