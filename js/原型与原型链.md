...
fn1.call(fn2); // 1 ，this指向fn2，立即执行一次. fn2函数也是对象
// 相当于执行下面的代码
// fn2.num = 111
// fn2.sayHey = function() {
//    console.log("say hey.");
...
fn1(); // 1
window.num; // 111, 这里单独执行fn1后，this指向全局对象，所以window.num=111
fn1.num; // undefined
fn1.sayHey(); // fn1.sayHey is not a function

fn2(); // 2
window.num; // 222，this指向全局对象，window.num被重新赋值
...
var f = new F(); // new一个对象，f.__proto__=F.prototype

f.a(); // a
f.b(); // f.b is not a function, 这里f只是一个对象
