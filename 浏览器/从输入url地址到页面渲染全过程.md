...
> 首先会检查本地hosts文件，看是否有对应的域名。
>
> - 比如配置dynamo域名的时候，可以直接在本地host文件加一下 域名+本地ip 的映射，就可以直接访问dynamo域名了。
> - 包括localhost的访问，估计也是在hosts文件里面配置了127.0.0.1	localhost。
> - host编辑工具：[**SwitchHosts**](https://github.com/oldj/switchhosts/releases)
>
> 如果没有的话才会进行dns解析。
